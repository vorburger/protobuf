...
public final class Descriptors {
  ...
  private static final HashMap<ByteString, FeatureSet> FEATURE_CACHE = new HashMap<>();

  @SuppressWarnings("NonFinalStaticField")
  private static FeatureSetDefaults javaEditionDefaults = null;
  ...
  private static synchronized FeatureSet internFeatures(FeatureSet features) {
    ByteString serialized = features.toByteString();
    FeatureSet cached = FEATURE_CACHE.get(serialized);
    if (cached == null) {
      FEATURE_CACHE.put(serialized, features);
      cached = features;
    }
    return cached;
  }
  ...
  public static final class FileDescriptor extends GenericDescriptor {
    ...
    public FileOptions getOptions() {
      synchronized (this) {
        if (this.options == null) {
          ...
          if (this.options.hasFeatures()) {
            this.options = this.options.toBuilder().clearFeatures().build();
          }
        }
      }
      return this.options;
     ...
     */
    public synchronized void resolveAllFeatures() {
      ...
      for (final EnumDescriptor enumType : enumTypes) {
  ...
  public static final class FieldDescriptor extends GenericDescriptor
    ...
    public boolean legacyEnumFieldTreatedAsClosed() {
      // Don't consider Java features for descriptor.proto since legacyEnumFieldTreatedAsClosed()
      // is also called when getting Java features extension.
  ...
  public abstract static class GenericDescriptor {
    ...
    FeatureSet resolveFeatures(FeatureSet unresolvedFeatures) throws RuntimeException {
      if (this.parent != null
